...
private val palettes = lightOnlyPalettes() + mapOf(
    AppThemeId.TEAL to ThemePalette(
        preview = Color(0xFF2B8F84),
        light = lightColorScheme(
            primary = Color(0xFF2B8F84),
            onPrimary = Color.White,
            primaryContainer = Color(0xFFDDEEE8),
            onPrimaryContainer = Color(0xFF143B36),
            secondary = Color(0xFFE7B64A),
            onSecondary = Color(0xFF45320A),
            secondaryContainer = Color(0xFFF4E6BD),
            onSecondaryContainer = Color(0xFF4E3A11),
            tertiary = Color(0xFF4F9C79),
            onTertiary = Color.White,
            tertiaryContainer = Color(0xFFE4F0D4),
            onTertiaryContainer = Color(0xFF234031),
            background = Color(0xFFF8F4EC),
            onBackground = Color(0xFF163530),
            surface = Color(0xFFFFFCF7),
            onSurface = Color(0xFF163530),
            surfaceVariant = Color(0xFFEDE3D4),
            onSurfaceVariant = Color(0xFF5E625C),
            outline = Color(0xFFCFBFAB),
        ),
        dark = darkColorScheme(
            primary = Color(0xFF69C2B8),
            onPrimary = Color(0xFF0C302C),
            primaryContainer = Color(0xFF1A4F48),
            onPrimaryContainer = Color(0xFFD9F0E8),
            secondary = Color(0xFFF0C86B),
            onSecondary = Color(0xFF443108),
            secondaryContainer = Color(0xFF5C4514),
            onSecondaryContainer = Color(0xFFF7E7BF),
            tertiary = Color(0xFF88C8A7),
            onTertiary = Color(0xFF173125),
            tertiaryContainer = Color(0xFF244C39),
            onTertiaryContainer = Color(0xFFD8EEDC),
            ...
            onSurfaceVariant = Color(0xFFC9C0B3),
            outline = Color(0xFF7E7A70),
        ),
    ),
